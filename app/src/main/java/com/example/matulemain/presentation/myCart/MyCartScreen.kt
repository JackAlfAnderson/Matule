...
fun MyCartScreen(navController: NavController) {
    ...
    Box (Modifier.fillMaxSize(), contentAlignment = Alignment.BottomCenter){
        Column (
            Modifier.height(258.dp).background(Color.White).fillMaxWidth().padding(20.dp)
        ){
            Spacer(Modifier.height(20.dp))
            Box {
                Box(Modifier.fillMaxWidth()) {
            ...
            Image(painterResource(R.drawable.cartline), null, Modifier.fillMaxWidth().height(5.dp))
        ...
        Row(modifier = Modifier.padding(10.dp), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.Center ) {
            Card(
                ...
                Box(contentAlignment = Alignment.Center, modifier = Modifier.fillMaxSize()){
                    Icon(
                        painterResource(R.drawable.thirdsneaker), null, tint = Color.Unspecified
                    )
                }
...
private fun MyCartPreview() {
    MyCartScreen(rememberNavController())
}